      ...
      <section className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {
                step: '01', title: 'Publica tu partido',
                desc: 'Indica las posiciones que necesitas, el distrito, horario y presupuesto.',
                img: IMGS.estadio, icon: '📋'
              },
              {
                step: '02', title: 'Recibe ofertas',
                desc: 'Los jugadores te envían sus propuestas con sus precios y disponibilidad.',
                img: IMGS.jugadores, icon: '⚡'
              },
              {
                step: '03', title: '¡A jugar!',
                desc: 'Elige al jugador ideal, confirma el pago y a jugar la pichanga.',
                img: IMGS.partido, icon: '🎉'
              },
            ].map(item => (
          ...
          <div className="absolute inset-0 flex items-center justify-end px-8 md:px-20">
            <div className="text-white text-right max-w-md">
              ...
              <p className="text-white/80">
                Rookie → Amateur → Profesional → <span className="text-yellow-300 font-bold">Elite</span>
              </p>
